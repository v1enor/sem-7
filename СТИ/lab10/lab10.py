...
harris_ksize = 3  # Размер ядра Sobel для детектора Харриса
harris_k = 0.04  # Параметр k для детектора Харриса
shi_tomasi_max_corners = 100  # Максимальное количество точек для детектора Ши-Томаси
shi_tomasi_quality_level = 0.01  # Порог качества для детектора Ши-Томаси
